  ...
  return (
    <div className="flex items-center mt-2 border-t border-b border-black text-base">
      <button
        ...
        className={"p-3 text-center border-r border-black text-[#231f20] hover:bg-[#231f20] duration-300 hover:text-white"}
      >
        <PiMinus className="text-[18px]"/>
      </button>
      <span className="font-semibold w-12 text-center text-[#231f20] text-[14px]">{itemCount}</span>
      <button
        onClick={() => {
          addItem(product);
          toast.success(
