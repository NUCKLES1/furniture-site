...
const Section = () => {
    return (
        ...
        <div className='w-full h-[100dvh]'>
         ...
         <BackgroundVideo src="https://www.lyon-beton.com/wp-content/uploads/2024/04/VIDEO-16-9-HOME-1.webm" className='max-sm:h-[100dvh]' autoPlay muted loop playsInline/> 
