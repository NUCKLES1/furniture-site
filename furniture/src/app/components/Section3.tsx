    ...
    return (
        <div className='w-[98%] ml-[1%] max-sm:w-[96%] max-sm:ml-2 mt-16 h-full bg-[#ebebeb] mb-48'>
            <div className='w-full pt-20 text-center max-sm:block flex'>
                <p className='tiny w-24 max-sm:w-auto text-[#231f20] text-center max-sm:text-center max-sm:text-[0.9rem]'>A never-before-seen design anchored in our collective memory.</p>
                <p className='text-7xl max-sm:text-5xl ml-[20%] mt-2 max-sm:ml-0 bold text-[#231f20]'>I CREATE <br /> UNSEEN DESIGN</p>
            </div>
