            ...
            <div className="w-full lg:flex">
              <form action="">
                <input
                  ...
                  className="w-44 max-sm:w-full bg-transparent text-[12px] max-sm:text-xl max-sm:pb-2 border-b outline-none hover:border-[#231f20] border-[#746d6d46] text-black pb-2 mt-8"
                />
              </form>
              <form action="">
                <input
