  ...
  return (
    <div className='w-full h-[100vh]'>
      <div className='w-full pt-20 max-sm:mt-[-15rem] h-[80vh]'>
        ...
        {projects.map((val) => (
          <div className='flex max-sm:block do border-line h-12 max-sm:h-[auto] max-sm:text-[18px] text-[#575555] hovering border-line tinny justify-between bold p-4' key={val.id}>
            <p>{val.title}</p>
