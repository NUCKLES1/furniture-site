...
const Section2 = () => {
    return (
        <div className='w-full h-[100vh] max-sm:h-auto bg-[#ebebeb]'>
            ...
            <div className='w-full mt-12 flex ml-3 max-md:h-[35vh] max-md:w-[98%] max-sm:ml-0 max-sm:block max-sm:h-auto h-[60vh]'>
                <div className='w-[24%] max-sm:w-[96%] max-sm:ml-2 max-sm:h-[25rem] h-full ima overflow-hidden bg-[#e3e3e3]'>
                    ...
                    <Image src={dc1} width={200} height={200} alt='' className='mt-8 max-md:mt-[-1rem] cale ml-10 max-sm:ml-[24%] max-md:ml-0' />
                ...
                <div className='w-[24%] max-sm:w-[96%] max-sm:ml-2 max-sm:h-[25rem]
                 h-full ima overflow-hidden ml-2 max-sm:mt-2 bg-[#e3e3e3]'>
                    ...
                    <Image src={dc3} width={200} height={200} alt='' className='mt-8 max-md:mt-[-1rem] cale ml-10 max-sm:ml-[24%] max-md:ml-0' />
                    <div className='flex mt-14 conti ml-2'>
                ...
                <div className='w-[24%] max-sm:w-[96%] max-sm:ml-2 max-sm:h-[25rem]
                 h-full ima overflow-hidden ml-2 max-sm:mt-2 bg-[#e3e3e3]'>
                    ...
                    <Image src={dc4} width={200} height={200} alt='' className='mt-8 max-md:mt-[-1rem] cale ml-10 max-sm:ml-[24%] max-md:ml-0' />
