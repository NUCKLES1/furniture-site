...
const CartPage = () => {
  ...
  return (
    <div className="w-full h-screen bg-[#ebebeb]">
      <Navbar />
      <div className="w-full pt-24 px-24 h-full">
            ...
            {cartProducts?.length ? (
              <>
                {cartProducts?.map(({ product }) => {
                  return (
                    <div
                      className="grid lg:grid-cols-3 md:gap-8 overflow-hidden"
                      key={product._id}
                    >
                      <div className="border-b p-2.5 w-80 last:border-b-0 flex items-center justify-between gap-5 overflow-hidden">
                      ...
                      <button className="" onClick={handleResetCart}>
                        reset
                      </button>
                    </div>
                  );
